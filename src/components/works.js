                ...
                <div className="columns abtCol">
                    ...
                    <Accordion>
                        <AccordionItem>
                            ...
                            <AccordionItemPanel>
                                <p className="is-white-custom is-size-5-desktop">
                                ...
                                <br/>                                
                                <p className="is-white-custom is-size-5-desktop has-text-weight-bold">
                                What type of websites to I build;
                                </p>
                                <ul>
                                    <li className="is-size-5 is-grn">1. One Pager websites suitable for; App Landing Pages, Portfolio Websites.</li>
                                    <li className="is-size-5 is-grn">2. Small business / corporate websites. This one may have 3-5 pages.</li>
                                    <li className="is-size-5 is-grn">3. Full coporate website. It is suitable for companies who offer various kind of services and products.</li>
                                    <li className="is-size-5 is-grn">4. Small scale Content Management Systems (C.M.S). A content management system is a dynamic website that allow 
                                                                    you to upload images, write articles or upload videos. A good example is a website that has blogging capabilities.
                                    </li>
                                    <li className="is-size-5 is-grn">5. Large scale content management systems. Its like the small  scale C.M.S but with more powerful tools for content handling and has some
                        ...
                        <AccordionItem>
                            ...
                            <AccordionItemPanel>
                                ...
                                <ul>
                                    <li className="is-size-5 is-grn">01. Websites</li>
                                    <li className="is-size-5 is-grn">02. WebApps</li>
                                    <li className="is-size-5 is-grn">03. Mobile Apps</li>
                                </ul>
                            </AccordionItemPanel>
                        </AccordionItem>
                        <AccordionItem>
                ...
                <div className="columns center">
                    ...
                    <div className="column is-one-third-desktop center">
                        <button className="button is-rounded sectionGreyBg is-large">
                            <p className="is-grn">Get in Touch</p>
                        </button>
                    </div>
                    <div className="column is-one-third-desktop"></div>
                </div>
